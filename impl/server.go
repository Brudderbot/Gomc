...
import (
	...
	"github.com/Brudderbot/Gomc/impl/conf"
	"github.com/Brudderbot/Gomc/impl/data/plugin"

	"github.com/Brudderbot/Gomc/impl/conn"
	"github.com/Brudderbot/Gomc/impl/cons"
	"github.com/Brudderbot/Gomc/impl/data/system"
	"github.com/Brudderbot/Gomc/impl/data/values"
	"github.com/Brudderbot/Gomc/impl/prot"

	apis_base "github.com/Brudderbot/Gomc/apis/base"
	impl_base "github.com/Brudderbot/Gomc/impl/base"

	apis_event "github.com/Brudderbot/Gomc/apis/game/event"
...
func (s *server) ForEachPlayer(cb func(ents.Player)) {
	for _, player := range s.players.uuidToData {
		cb(player)
	}
}
...
func (s *server) stopServerCommand(sender ents.Sender, params []string) {
	...
	if after == 0 {
		...
		s.tasking.AfterTime(time.Duration(after)*time.Second, func(task *task.Task) {
			s.Kill()
		})
