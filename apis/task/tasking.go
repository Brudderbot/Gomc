...
func (t *Tasking) EveryTime(d time.Duration, function func(task *Task)) {
	t.repeats(d.Milliseconds(), function)
}

func (t *Tasking) AfterTime(d time.Duration, function func(task *Task)) {
	t.delayed(d.Milliseconds(), function)
}
